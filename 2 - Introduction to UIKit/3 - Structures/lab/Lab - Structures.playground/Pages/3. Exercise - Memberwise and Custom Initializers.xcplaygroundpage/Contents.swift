...
let favoriteBook = Book(title: "Angels and Demons", author: "Dan Brown", pages: 616, price: 9.99)
print("My favorite book is \(favoriteBook.title) which is written by \(favoriteBook.author). The book has \(favoriteBook.pages) pages. It currently cost $\(favoriteBook.price).")
/*:
 ...
 */
let myHeight = Height(heightInInches: 75)
