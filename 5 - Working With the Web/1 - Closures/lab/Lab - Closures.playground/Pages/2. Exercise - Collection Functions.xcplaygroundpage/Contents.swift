 ...
 */
var barton = ["Courtney", "Cory", "Tessa", "Presley", "Deanna"]
let sortedCollection1 = barton.sorted(by: forwards)
 ...
 */
let sortedCollection2 = barton.sorted(by: { (firstName: String, secondName: String) -> Bool in
 ...
 */
let sortedCollection3 = barton.sorted { return $0 < $1 }
