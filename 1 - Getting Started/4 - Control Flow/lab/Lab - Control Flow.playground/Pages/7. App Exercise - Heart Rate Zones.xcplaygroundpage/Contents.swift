...
case 141...160:
    print("You are in the Moderate Zone. Activity ion this zone helps improve aerobic fitness.")
case 161...180:
    print("You are in the Hard Zone. Acitivity in this zone increases maximum performance capacity for shorter sessions.")
case 181...200:
    print("You are in the Maximum Zone. Activity in this zone helps fit athletes develop speed.")
default:
    print("Warning you are in the Danger Zone. Cue music from Top Gun.")
}
