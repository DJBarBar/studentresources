 ...
 */
func mealFor(timeFrame: String) -> Meal? {
    return meals[timeFrame]
}

if let breakfast = mealFor(timeFrame: "Breakfast") {
    print("The food in the breakfast is:" )
    for food in breakfast.food {
        print(food)
    }
}
