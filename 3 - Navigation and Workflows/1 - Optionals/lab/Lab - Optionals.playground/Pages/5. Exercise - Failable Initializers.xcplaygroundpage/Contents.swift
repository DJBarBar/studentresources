 ...
 */
let appleOne = Computer(ram: 205, yearManufactured: 2011)
if let appleOne = appleOne {
    print("The ram is \(appleOne.ram) and the yearManufactured is \(appleOne.yearManufactured) for the apple One.")
}
